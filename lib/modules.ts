...
export const MODULES: AppModule[] = [
  ...
  },
  {
    ...
    desc: "Qué se trabaja de balón parado cada día y cómo se nota",
    icon: Goal,
    rank: 93,
    alias: ["balon parado", "abp", "microciclo de abp"],
  },
  {
    href: "/abp-pizarra",
    area: "METODOLOGÍA",
    title: "Pizarra de Balón Parado",
    desc: "Las diapositivas del partido: quién va en cada puesto",
    icon: ClipboardList,
    rank: 91,
